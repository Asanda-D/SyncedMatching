        ...
        listOf(
            ...
            btn.setOnClickListener {
                ...
                selectedAvatarId = when (btn.id) {
                    ...
                    R.id.yellowButton -> R.drawable.rounded_button_yellow
                    R.id.purpleButton -> R.drawable.rounded_button_purple
                    R.id.cyanButton -> R.drawable.rounded_button_cyan
                    R.id.grayButton -> R.drawable.rounded_button_gray
